...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(CommonPage, "CommonPage").$$render($$result, { title }, {}, {
    default: () => {
      return `<div class="resume svelte-wl30ce">${item ? `<a target="_blank"${add_attribute("download", item, 0)}${add_attribute("href", item, 0)} class="svelte-wl30ce">${validate_component(Chip, "Chip").$$render($$result, { size: "1.25em" }, {}, {
        default: () => {
          return `Download`;
        }
